...
public final class DropDown: UIView {
	...
	*/
	@objc public dynamic var shadow_Radius = DPDConstant.UI.Shadow.Radius {
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.shadowRadius = shadow_Radius
...
extension DropDown {
	...
	public override func layoutSubviews() {
		...
		let shadowPath = UIBezierPath(roundedRect: tableViewContainer.bounds, cornerRadius: corner_Radius)
